  ...
  return (
    <header className={`text-white sticky top-0 left-0 ${(musicDisplay || subscribeDisplay) ? "-z-10" : "z-50"}`}>
        <nav className='flex items-center justify-around'>
            ...
            <button 
              className='w-full uppercase rounded-b-full border-2 hover:bg-white hover:text-black hover:font-medium py-2 text-center cursor-pointer text-sm md:text-xl' 
